                            ...
                            <div class="col-lg-12">
                                <div class="card shadow animate__animated animate__fadeInUp" style="height: 750px;">
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold">Attendence</h6>
                                        
                                    </div>
                                    <!--card Body-->
                                    <div class="card-body" style="height: 400px; overflow-y: auto; overflow-x: auto; width: auto;">
                                        <table class="table table-hover" id="table">
                                            <thead>
                                                <tr>
                                                    <th scope="col-md-3 pr1">Date</th>
                                                    <th scope="col-md-3 pr1">Status</th>
                                                    <th scope="col-md-3 pr1">PunchTime</th>
