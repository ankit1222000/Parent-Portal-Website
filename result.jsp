            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <a class="navbar-brand active" href="#">Result</a>
                                ...
                                <div class="card shadow mb-4 animate__animated animate__fadeInUp">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4 text-center small">
                                            ...
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-info"></i> Practicle
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card shadow animate__animated animate__fadeInUp">
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold">Result Section</h6>
                                    </div>
			        </div>
					...
					<td>September</td>
					<td>Unit Test I</td>
					<td>Pass with 70% in all subjects</td>
			
					</tr>
					<tr>
					<td>November</td>
					<td>Unit Test II</td>
					<td>Pass with 80% in all subjects</td>
			
					</tr>
					<tr>
					<td>December</td>
					<td>Pre Board I</td>
					<td>Pass in all subjects except Mathematics: 58%</td>
					</tr>
					<tr>
					<td></td>
					<td></td>
					...
					<div class="card-body" style="height: 400px; overflow-y: auto; overflow-x: hidden; width: auto;">
                                        <div class="row">
                                            <h5 style="margin-left: 15px;">First Class</h5>
                                        </div>
                                        <div class="row">
                                            <!-- Page Heading -->
                                            <div class="justify-content-between mb-4">
                                                <a href="#" class="d-none d-sm-inline-block btn btn-sm shadow-sm" style="background-color: red; color: white; margin-left: 20px;"><i
                                                        class="fas fa-download fa-sm" style="color: white;"></i> Download Report</a>
                                            </div>
                                        </div>
